      ...
      <section className="container-content max-w-3xl py-14">
        <figure className="mb-10">
          ...
          <figcaption className="mt-3 text-center text-sm italic text-ink/60">
            &ldquo;In him you also are being built together into a dwelling
            place for God by his Spirit.&rdquo; — painted on the mission church
            in Belize
          </figcaption>
        </figure>
        ...
        <div className="mt-12 rounded-2xl bg-deep p-8 text-white">
          ...
          <p className="mt-2 text-white/80">
            Medical care for families. Reading glasses that restore a
            livelihood. Study Bibles for village pastors. This is what your
            generosity does.
          </p>
          <div className="mt-5 flex flex-col gap-3 sm:flex-row">
            <GiveLink
              location="belize_bottom"
              fund="belize-trip"
              className="btn-give"
            >
