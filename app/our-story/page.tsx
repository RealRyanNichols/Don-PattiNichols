    ...
    <>
      ...
      <section className="container-content max-w-3xl py-14">
        <div className="prose-mission">
          <p>
            This page is more than an &ldquo;about&rdquo; page. It is a record —
            of who Don and Patti Nichols are, what they believe, how they have
            lived, and the work God has done through them. It is being written
            for the people they serve today, and for their children, their
            grandchildren, and the generations who will read it long after.
          </p>
          <p>
            Don preaches the Word of God. Together, Don and Patti serve on
            medical mission teams carrying free clinics, Bibles, and the hope of
            Jesus Christ into the villages of Belize — and they serve their own
            community at home the same way: personally, faithfully, and in the
            name of Christ.
          </p>
          <p>
            Their full story — their faith journey, their family, their years of
            ministry, and the moments that shaped them — is being gathered now,
            in their own words, along with photographs and videos from across
            the years.
          </p>
        </div>
